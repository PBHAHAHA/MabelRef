 ...
 * [OUTPUT]: 对外提供 applyCanvasFocusMode/applyWindowPinMode，用于切换画布专注模式与普通置顶窗口层级
...
export function applyWindowPinMode(window, enabled) {
  window.setAlwaysOnTop(enabled, enabled ? 'floating' : 'normal')
}
