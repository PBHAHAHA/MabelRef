 ...
 * [OUTPUT]: 对外提供 getAnchoredZoomView 与 getWheelZoomFactor，计算以指针为锚点的画布缩放视图和细步进滚轮缩放因子
 * [POS]: renderer/canvas 的视口缩放纯函数，被 useLeaferImageEditor 消费
...
export function getManualWheelZoomInteractionConfig() {
  return {
    wheel: {
      disabled: true
    },
